...
const SOURCE_PROVENANCE = Object.freeze({
  ...
  // Grok Build has no permissively-licensed upstream mark in this repository.
  // This is a code-native fallback authored for Clawd and generated by
  // tools/generate-grok-fallback-icon.js, released as CC0-1.0. It is not the
  // xAI/Grok logo and carries no upstream artwork.
  "grok-build": {
    originalFilename: "grok-fallback.png",
    sourceFilename: "grok-fallback.png",
    fallback: true,
    exportMode: "passthrough",
    license: "CC0-1.0",
    provenance: "Code-native two-tone ring generated by tools/generate-grok-fallback-icon.js; CC0-1.0; not the xAI/Grok logo.",
  },
  // MiniMax Code placeholder mark, same rationale as grok-build: a code-native
  // two-tone "M" letterform generated by tools/generate-minimax-fallback-icon.js
  // and released as CC0-1.0. It is not the MiniMax logo.
  minimax: {
    originalFilename: "minimax.png",
    sourceFilename: "minimax.png",
    fallback: true,
    exportMode: "passthrough",
    license: "CC0-1.0",
    provenance: "Code-native two-tone M letterform generated by tools/generate-minimax-fallback-icon.js; CC0-1.0; not the MiniMax logo.",
  },
