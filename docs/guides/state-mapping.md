...
| Permission request still pending (display override) | waiting | Reading / theme waiting visual — a display-only lift of `working`/`thinking` while a permission request is pending; themes without a `waiting` state keep the working visual. Not active while sleeping/DND or in mini mode | <img src="../../assets/gif/clawd-idle-reading.gif" width="160"> | | <img src="../../assets/gif/cloudling-idle-reading.gif" width="140"> |
